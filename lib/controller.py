...
from lib.models.annotategenome import AnnotateGenome
from lib.models.homolog import homolog
...
class Controller(QObject):
    ...
    annotateStep = pyqtSignal(tuple, tuple, str, str)
    getHomolog = pyqtSignal(tuple, tuple, str, str, str, str)
    ...
    rnatorS3 = pyqtSignal(tuple, dict, str)
...
#_________________________________________General Functions________________________________________#
    ...
    def establishingConnections(self):
        ...
        self.annotateStep.connect(self.annotategenome.annotategen)#checked1
        self.annotategenome.annotateStepDone.connect(self.writingCache)
        self.getHomolog.connect(self.proteinHomolog.getProteinHomolog)
        ...
        self.rnatorS3.connect(self.rnator.rnatorProcesslong)#checked1
    ...
    def initialization(self):#checked
        ...
        self.rnator = RNAtor()
        self.annotategenome = AnnotateGenome()
        self.proteinHomolog = homolog()
    ...
    def startWorkerThread(self):#checked
        ...
        self.annotategenome.moveToThread(self.workerThread)
        self.proteinHomolog.moveToThread(self.workerThread)
...
#__________________________________Project Management Controllers__________________________________#
    ...
    def openProjectController(self, projectPath):#checked
        ...
        if genomes:
            ...
            self.project.setRNAtorStep3Info(genomes[-1])
            self.initialization()
            self.startWorkerThread()
            self.establishingConnections()
            self.writeCacheOperate.emit((self.project,))
...
#_______________________________________Annotator functions________________________________________#
    ...
    def annotateGenomeStepController(self, tickedGenomes, threads, genpath):
        self.annotateStep.emit((self.project, ),tickedGenomes, threads, genpath)

    
    def homologStepController(self, tickedGenomes, threads, get_method, get_Lt, get_similarity):
        self.getHomolog.emit((self.project, ), tickedGenomes, threads, get_method, get_Lt, get_similarity)
...
#_________________________________________RNAtor functions_________________________________________#
    ...
    def rnatorStep3(self, genomesInfo, threads):#checked1
        self.rnatorS3.emit((self.project, ), genomesInfo, threads)
