...
class Project(QObject):
    ...
    def getAnnotateStepInfo(self):
        return self.annotateStep
    ...
    def getRNAtorStep3Info(self):
        return self.rnatorStep3
    ...
    def setRNAtorStep3Info(self, dictInfo):
        self.rnatorStep3 = dictInfo
    ...
    def setRNAtorStep3Genome(self, genomeName, value):#checked1
        self.rnatorStep3[genomeName] = value
    ...
    def setAllStepsGenome(self, genomeName, value):#checked1
        ...
        self.setRNAtorStep3Genome(genomeName, value)
    ...
    def addGenome(self, genomeName):#checked
        ...
        self.rnatorStep3[genomeName] = False
    ...
    def removeGenome(self, genomeName):#checked
        ...
        del self.rnatorStep3[genomeName]
